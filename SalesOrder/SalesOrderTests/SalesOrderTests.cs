...
namespace SalesOrder.Tests
{
    ...
    public class SalesOrderTests
    {
        ...
        [TestMethod()]
        public void SalesOrderTest_GetTotalFieldSumbyGroup_field_Revenue_group_4()
        {
            //Arrange
            ...
            //Actual
            int[] actual = target.GetTotalFieldSumbyGroup(4, solist, "Revenue");
        ...
        [TestMethod()]
        public void SalesOrderTest_GetTotalFieldSumbyGroup_field_Cost_group_3()
        {
            //Arrange
            var target = new SalesOrder();
            List<SalesOrder> solist =
            ...
            //Actual
            int[] actual = target.GetTotalFieldSumbyGroup(3, solist, "Cost");
        ...
        [TestMethod()]
        public void SalesOrderTest_GetTotalFieldSumbyGroup_field_SellPrice_group_3()
        {
            //Arrange
            var target = new SalesOrder();
            List<SalesOrder> solist =
            ...
            //Actual
            int[] actual = target.GetTotalFieldSumbyGroup(3, solist, "Sellprice");

            //Assert
            var expected = new int[] { 66, 75,84, 61 };
            CollectionAssert.AreEqual(expected, actual);
        }
    }
}